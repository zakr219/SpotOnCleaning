  ...
  const payrollData = [
    {
      ...
      items: [
        [1, 40, 18.00, 720, 108, 612, null],
        [2, 36, 16.50, 594, 89.10, 504.90, null],
        [3, null, 120, 120, 0, 120, '1 job'],
      ]
    },
    {
      run: ['2026-01-16', '2026-01-31', '2026-02-03', 1698, 'paid', 'Jan second half'],
      items: [
        [1, 44, 18.00, 792, 118.80, 673.20, null],
        [2, 38, 16.50, 627, 94.05, 532.95, null],
        [3, null, 120, 240, 0, 240, '2 jobs'],
        [4, 16, 17.00, 272, 40.80, 231.20, 'Hired mid-month'],
      ]
    },
    {
      run: ['2026-02-01', '2026-02-15', '2026-02-17', 1714, 'paid', 'Feb first half'],
      items: [
        [1, 42, 18.00, 756, 113.40, 642.60, null],
        [2, 38, 16.50, 627, 94.05, 532.95, null],
        [3, null, 120, 120, 0, 120, '1 job'],
        [4, 24, 17.00, 408, 61.20, 346.80, null],
      ]
    },
    {
      ...
      items: [
        ...
        [2, 36, 16.50, 594, 89.10, 504.90, null],
        [3, null, 120, 240, 0, 240, '2 jobs'],
        [4, 26, 17.00, 442, 66.30, 375.70, null],
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        [1, 48, 18.00, 864, 129.60, 734.40, null],
        [2, 40, 16.50, 660, 99, 561, null],
        [3, null, 120, 120, 0, 120, '1 job'],
        [4, 26, 17.00, 442, 66.30, 375.70, null],
      ]
